...
window.addEventListener("load", function(event) {
  ...
  var render = function() {
    ...
    display.drawRectangle(game.world.object.x, game.world.object.y, game.world.object.width, game.world.object.height, game.world.object.color);
    display.render();
  ...
  var update = function() {
    ...
    if (controller.down.active)  { game.world.player.crouch();}
    if (!controller.down.active) {game.world.player.uncrouch();}
